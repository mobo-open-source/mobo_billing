...
/// Mixin to handle data loss warnings when navigating away from a dirty form.
mixin DataLossWarningMixin<T extends StatefulWidget> on State<T> {
  ...
  /// Intercepts back-navigation to show a warning if there is unsaved data.
  ...
  /// Wraps a navigation action with a data-loss check.
