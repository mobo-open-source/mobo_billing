...
import 'package:mobo_billing/widgets/list_shimmer.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
    ...
    try {
      ...
      if (mounted) {
        CustomSnackbar.showError(
          context,
          'Could not open link: ${e.toString()}',
        );
      }
    }
  }
  ...
  Widget _buildBiometricTile(BuildContext context) {
    final icon = _isBiometricAvailable
  ...
  Widget _buildSocialButton(
    ...
    return Column(
      ...
      children: [
        ...
        Container(width: 48, height: 3, child: const SizedBox.shrink()),
      ],
    );
  }
  ...
  Widget _buildProfileCard(
    ...
    final imageData = userProfile['image_1920'];

    Uint8List? avatarBytes;
    if (imageData is String && imageData.isNotEmpty) {
      try {
        avatarBytes = base64Decode(imageData);
      } catch (_) {}
    }
    ...
    if (avatarBytes != null) {
      ...
      photoWidget = _buildDefaultAvatar();
    }
