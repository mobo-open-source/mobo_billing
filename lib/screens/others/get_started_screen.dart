...
class _GetStartedScreenState extends State<GetStartedScreen> {
  String _getImagePath(String baseName) {
    if (Platform.isIOS) {
      return 'assets/onboarding_${baseName}_ios.jpg';
    }
    return 'assets/onboarding_$baseName.jpg';
  }

  late final List<Map<String, String>> onboardingData = [
    {
      'image': _getImagePath('1'),
      'title': 'All Your Billing Data\nin One Place',
      'description':
          'View dashboard metrics, manage customers, create invoices, and track payments seamlessly',
    },
    {
      'image': _getImagePath('2'),
      'title': 'Connected to Odoo',
      'description':
          'Real-time sync with your Odoo system keeps all customer data, products, and billing records up-to-date',
    },
    {
      'image': _getImagePath('3'),
      'title': 'Mobile Billing\nManagement',
      'description':
          'Create invoices, manage products, track payments, and handle credit notes from anywhere',
    },
  ];
